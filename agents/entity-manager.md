...
旧行:
| char_005 | 角色 | {旧角色名} | - | chapter-003 | {主角}堂兄 |

新行:
| char_005 | 角色 | {新角色名} | - | chapter-003 | {主角}堂兄 |
```
...
新行:
| char_001 | 角色 | {主角} | {主角昵称} | chapter-001 | 主角 |
```
...
示例冲突:
| char_005 | 角色 | {女主A} | - | chapter-010 | {势力}宗主 |
| char_018 | 角色 | {女主A} | {女主A昵称} | chapter-025 | 女主之一 |
...
示例:
| char_001 | 角色 | {主角} | {主角昵称} | chapter-001 | 主角 |
| char_012 | 角色 | {配角} | {主角昵称} | chapter-015 | 配角 |
...
示例:
| char_001 | 角色 | {主角} | - | chapter-001 | 主角 |
| char_020 | 角色 | {主角昵称} | - | chapter-020 | 新角色 |

❌ 冲突: char_001的可能别名"{主角昵称}"是char_020的标准名称
```
...
示例:
| char_008 | 角色 | {相似名A} | - | chapter-005 | 配角 |
| char_001 | 角色 | {主角} | - | chapter-001 | 主角 |

⚠️  相似: "{相似名A}" 与 "{主角}" 编辑距离=1
可能是拼写错误?
```
...
```markdown
合并后:
| char_005 | 角色 | {女主A} | {女主A昵称} | chapter-010 | {势力}宗主/女主 |
...
### 主要角色 (5个)
1. char_001 - {主角} (主角, 出现70次)
2. char_002 - {女主A} (女主, 出现45次)
3. char_003 - {导师} (导师, 出现38次)
4. char_005 - {女主B} (女主, 出现32次)
5. char_007 - {女主C} (女主, 出现28次)

### 反派角色 (3个)
1. char_010 - {反派A} (反派, 出现15次)
2. char_015 - {反派B} (反派, 出现8次)
3. char_020 - {反派C} (反派, 出现6次)
...
1. place_001 - {起始城镇} (18章提及)
2. place_002 - {历练地点} (12章提及)
3. place_005 - {主要势力} (8章提及)
...

## 物品重要度

1. item_001 - {核心功法} (核心物品, 25次)
2. item_003 - {导师遗物} (重要物品, 18次)
...
...
2. **大小写**: 替换时严格区分大小写
3. **正则模式**: 默认全词匹配,避免部分替换(如: "{主角}"不会替换"{主角}儿"中的"{主角}")
4. **别名限制**: 每个实体最多3个别名
