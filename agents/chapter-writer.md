...
4. **立即更新** productions/{project_id}/data/entities.md:
   - 追加新实体到对应表格（不是占位符 -，而是实际内容）
   - 更新主角的状态追踪（境界变化、获得的能力等）
   - 更新"最后更新"时间戳
```
...
每完成一章或一批章节后，**必须更新** `productions/{project_id}/data/progress.md`：
...
### 第一卷
- [x] 第1-10章 ✅ (2025-12-07)
- [x] 第11-20章 ✅ (2025-12-08)   ← 新增
- [x] 第21-30章 ✅ (2025-12-09)   ← 新增
- [ ] 第31-40章

## 创作日志
| 日期 | 章节 | 字数 | 备注 |
|------|------|------|------|
| 2025-12-09 | 第21章 xxx | 3200 | xxx |   ← 新增
| ... |
```
...
3. 每章创作完:
   - 保存章节文件
   - 更新 entities.md（新实体、状态变化）
   - 自动读取最新的entities.md用于下一章
4. 批量创作完成后:
   - 更新 data/progress.md（章节数、进度、字数、日志）
```
