...
|--------|------|----------|------|----------|
| char_001 | 角色 | 萧炎 | 炎儿 | chapter-001 |
| char_002 | 角色 | 萧薰儿 | 薰儿 | chapter-001 |
| place_001 | 地点 | 乌坦城 | - | chapter-001 |
| item_001 | 物品 | 焚决 | - | chapter-003 |
```
...
扫描所有章节,提取主角境界:
```markdown
chapter-001: 萧炎境界 = 斗之气
chapter-003: 萧炎境界 = 斗者3星
chapter-008: 萧炎境界 = 斗者9星
chapter-012: 萧炎境界 = 斗师2星
chapter-025: 萧炎境界 = 斗师9星
```
...
异常示例:
chapter-020: 萧炎从斗师9星 → 斗灵1星 ✅ 合法突破
chapter-025: 萧炎从斗灵3星 → 斗师8星 ❌ 境界倒退!
```
...
3. **别名支持**: entities.md可以定义合法别名,如"炎儿" → "萧炎"
