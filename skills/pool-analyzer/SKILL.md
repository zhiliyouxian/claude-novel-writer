...
### 盘龙体系 (10级)
魔法学徒 → 魔法师 → 大魔法师 → 魔导士 → 圣域 → 神级 → 下位神 → 中位神 → 上位神 → 主神
...
5. 生成融合风格报告
6. 生成套路模式提取
7. 回复: "已完成素材池分析。共3篇小说,20万字。融合风格参数: 平均句长15.6字,对话比例43%,爽点密度3.3/千字。识别到废柴流套路,推荐采用异火系统金手指。详见 pools/analysis/xuanhuan_1/"
```

### 示例2: 指定权重融合

```bash
用户: "分析素材池 xuanhuan_1, 权重: 斗破60%, 盘龙40%"
...
激活条件: 用户说"分析素材池"、"分析 pools/"等关键词时自动激活
